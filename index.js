...
const MONGO_URL = "mongodb://localhost:27017/menu2";

/*
const nombredb = "menu2";
const coleccionPlatos = "platos";
const coleccionCategorias = "categorias";
*/
const dbdata = { db: "menu2", colcat: "categorias", colplatos: "platos" };
  ...
  if (req.body.nombre) {
    MongoClient.connect(MONGO_URL, { useUnifiedTopology: true }, (err, db) => {
      ...
      res.render("altacategorias.html", {
        mensaje: `Alto exitosa ${req.body.nombre}`,
      });
    });
  } else {
    res.render("altacategorias.html");
  ...
  if (req.body.plato) {
    MongoClient.connect(MONGO_URL, { useUnifiedTopology: true }, (err, db) => {
      ...
      res.render("altaplatos.html", {
        mensaje: `Carga exitosa ${req.body.plato}`,
      });
    });
  } else {
    res.render("altaplatos.html");
